...
INSERT INTO transformation_templates (name, variable_structures, pipeline_state_type_id, last_actor) 
    VALUES       
        ...
        '{"input_transform":{"datatype": "string", "description": "The name of the transform to input source data from"},"col_status":{"dataype": "string","description": "The column of interest for this transform"}', 

...
class ConfigurationMocker(LoggerMixin):
    ...
    def _mock_transformation_variables(self)->None:
        ...
        self.session.add_all([
            ...
            tv(id=419, name="input_transform", transformation_id=28, value="symphony_health_association_extract_column_mapping"),
            tv(id=420, name="separator", transformation_id=28, value="|"),
            tv(id=421, name="compression", transformation_id=28, value=False),
            tv(id=422, name="filetype", transformation_id=28, value="dat"),
            tv(id=423, name="date_format", transformation_id=28, value="%Y%m%d_%Y%m%d%H%M%S"),

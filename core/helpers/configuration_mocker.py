...
class ConfigurationMocker(LoggerMixin):
    ...
    def _mock_transformation_variables(self)->None:
        ...
        self.session.add_all([
            tv(id=5, name='filesystem_path', transformation_id=2,
            ...
            tv(id=28, name='input_file_prefix',
               transformation_id=13, value='some-extracted-file'),
            ...
            tv(id=39, name="prefix", transformation_id=28,
               value="symphony_health_association"),
            tv(id=40, name="suffix", transformation_id=28, value=""),
            tv(id=41, name="remote_path", transformation_id=28,
               value="/upload/sha_dry_run_test_publish"),
            ...
            tv(id=439, name="input_transform", transformation_id=28,
               value="symphony_health_association_extract_column_mapping"),
            ...
            tv(id=443, name="date_format", transformation_id=28,
               value="%Y%m%d_%Y%m%d%H%M%S"),
            ...
            tv(id=59, name='ingest_source_transform',
               transformation_id=26, value="initial_ingest"),
            tv(id=60, name='ingest_source_file_prefix', transformation_id=26,
               value="INTEGRICHAIN_SUN_ACCREDO_STATUSDISPENSE"),
            tv(id=61, name='rec_date_col', transformation_id=26, value="Rec Date"),
            tv(id=62, name='pharm_code_col',
               transformation_id=26, value="Pharm Code"),
            tv(id=63, name='pharm_npi', transformation_id=26, value="Pharm NPI"),
            tv(id=64, name='transtype', transformation_id=26, value="transType"),
            tv(id=65, name='pharm_transaction_id',
               transformation_id=26, value="Pharm Transaction Id"),
            ...
            tv(id=71, name='pat_last_name',
               transformation_id=26, value="Pat Last Name"),
            tv(id=72, name='pat_first_name',
               transformation_id=26, value="Pat First Name"),
            ...
            tv(id=85, name='pres_last_name',
               transformation_id=26, value="Pres Last Name"),
            tv(id=86, name='pres_first_name',
               transformation_id=26, value="Pres First Name"),
            ...
            tv(id=95, name='facility_name',
               transformation_id=26, value="Facility Name"),
            ...
            tv(id=100, name='refill_remaining',
               transformation_id=26, value="Refill Remaining"),
            tv(id=101, name='prev_disp', transformation_id=26, value="prev Disp"),
            tv(id=102, name='rx_ndc_number',
               transformation_id=26, value="Rx NDC Number"),
            ...
            tv(id=107, name='ship_carrier',
               transformation_id=26, value="Ship Carrier"),
            tv(id=108, name='shiptracking_num',
               transformation_id=26, value="shipTracking Num"),
            tv(id=109, name='ship_location',
               transformation_id=26, value="Ship Location"),
            tv(id=110, name='ship_address',
               transformation_id=26, value="Ship Address"),
            ...
            tv(id=114, name='has_medical',
               transformation_id=26, value="Has Medical"),
            tv(id=115, name='primary_coverage_type',
               transformation_id=26, value="Primary CoverageType"),
            tv(id=116, name='primary_payer_name',
               transformation_id=26, value="Primary Payer Name"),
            tv(id=117, name='primary_payer_type',
               transformation_id=26, value="Primary Payer Type"),
            tv(id=118, name='secondary_coverage_type',
               transformation_id=26, value="Secondary CoverageType"),
            tv(id=119, name='secondary_payer_name',
               transformation_id=26, value="Secondary PayerName"),
            tv(id=120, name='secondary_payer_type',
               transformation_id=26, value="Secondary PayerType"),
            tv(id=121, name='plan_paid_amt',
               transformation_id=26, value="Plan Paid Amt"),
            tv(id=122, name='pat_copay', transformation_id=26, value="Pat Copay"),
            tv(id=123, name='copay_assist_amount',
               transformation_id=26, value="Copay Assist Amount"),
            tv(id=124, name='oth_payer_amt',
               transformation_id=26, value="Oth Payer Amt"),
            tv(id=125, name='xfer_pharmname',
               transformation_id=26, value="Xfer PharmName"),
            tv(id=126, name='msa_patient_id',
               transformation_id=26, value="MSA PATIENT ID"),
            tv(id=127, name='msa_patient_bmap',
               transformation_id=26, value="MSA PATIENT BMAP"),
            tv(id=404, name='metadata_run_timestamp',
               transformation_id=26, value="__metadata_run_timestamp"),
            tv(id=405, name='metadata_app_version',
               transformation_id=26, value="__metadata_app_version"),
            tv(id=406, name='metadata_output_contract',
               transformation_id=26, value="__metadata_output_contract"),

            tv(id=128, name='ingest_source_transform',
               transformation_id=37, value="initial_ingest"),
            tv(id=129, name='ingest_source_file_prefix', transformation_id=37,
               value="INTEGRICHAIN_SUN_BRIOVA_STATUSDISPENSE"),
            tv(id=130, name='rec_date_col', transformation_id=37, value="Rec Date"),
            tv(id=131, name='pharm_code_col',
               transformation_id=37, value="Pharm Code"),
            ...
            tv(id=134, name='pharm_transaction_id',
               transformation_id=37, value="Pharm Transaction Id"),
            ...
            tv(id=139, name='pharmacy_id',
               transformation_id=37, value="Pharmacy ID"),
            tv(id=140, name='pat_last_name',
               transformation_id=37, value="Pat Last Name"),
            tv(id=141, name='pat_first_name',
               transformation_id=37, value="Pat First Name"),
            ...
            tv(id=151, name='status_date',
               transformation_id=37, value="Status Date"),
            tv(id=152, name='status_code',
               transformation_id=37, value="Status Code"),
            tv(id=153, name='sub_status', transformation_id=37, value="Sub Status"),
            tv(id=154, name='pres_last_name',
               transformation_id=37, value="Pres Last Name"),
            tv(id=155, name='pres_first_name',
               transformation_id=37, value="Pres First Name"),
            ...
            tv(id=164, name='facility_name',
               transformation_id=37, value="Facility Name"),
            ...
            tv(id=169, name='refill_remaining',
               transformation_id=37, value="Refill Remaining"),
            tv(id=170, name='prev_disp', transformation_id=37, value="Prev Disp"),
            tv(id=171, name='rx_ndc_number',
               transformation_id=37, value="Rx NDC Number"),
            ...
            tv(id=176, name='ship_carrier',
               transformation_id=37, value="Ship Carrier"),
            tv(id=177, name='shiptracking_num',
               transformation_id=37, value="ShipTracking Num"),
            tv(id=178, name='ship_location',
               transformation_id=37, value="Ship Location"),
            tv(id=179, name='ship_address',
               transformation_id=37, value="Ship Address"),
            ...
            tv(id=183, name='has_medical',
               transformation_id=37, value="Has Medical"),
            tv(id=184, name='primary_coverage_type',
               transformation_id=37, value="Primary Coverage Type"),
            tv(id=185, name='primary_payer_name',
               transformation_id=37, value="Primary Payer Name"),
            tv(id=186, name='primary_payer_type',
               transformation_id=37, value="PrimaryPayer Type"),
            tv(id=187, name='secondary_coverage_type',
               transformation_id=37, value="Secondary Coverage Type"),
            tv(id=188, name='secondary_payer_name',
               transformation_id=37, value="Secondary Payer Name"),
            tv(id=189, name='secondary_payer_type',
               transformation_id=37, value="Secondary Payer Type"),
            tv(id=190, name='plan_paid_amt',
               transformation_id=37, value="Plan Paid Amt"),
            tv(id=191, name='pat_copay', transformation_id=37, value="Pat Copay"),
            tv(id=192, name='copay_assist_amount',
               transformation_id=37, value="Copay Assist Amount"),
            tv(id=193, name='oth_payer_amt',
               transformation_id=37, value="Oth Payer Amt"),
            tv(id=194, name='xfer_pharmname',
               transformation_id=37, value="Xfer PharmName"),
            tv(id=195, name='msa_patient_id',
               transformation_id=37, value="MSA PATIENT ID"),
            tv(id=196, name='msa_patient_bmap',
               transformation_id=37, value="MSA PATIENT BMAP"),
            tv(id=407, name='metadata_run_timestamp',
               transformation_id=37, value="__metadata_run_timestamp"),
            tv(id=408, name='metadata_app_version',
               transformation_id=37, value="__metadata_app_version"),
            tv(id=409, name='metadata_output_contract',
               transformation_id=37, value="__metadata_output_contract"),

            tv(id=197, name='ingest_source_transform',
               transformation_id=38, value="initial_ingest"),
            tv(id=198, name='ingest_source_file_prefix', transformation_id=38,
               value="INTEGRICHAIN_SUN_CIGNA_STATUSDISPENSE"),
            tv(id=199, name='rec_date_col', transformation_id=38, value="Rec Date"),
            tv(id=200, name='pharm_code_col',
               transformation_id=38, value="Pharm Code"),
            ...
            tv(id=203, name='pharm_transaction_id',
               transformation_id=38, value="Pharm Transaction Id"),
            ...
            tv(id=208, name='pharmacy_id',
               transformation_id=38, value="Pharmacy ID"),
            tv(id=209, name='pat_last_name',
               transformation_id=38, value="Pat Last Name"),
            tv(id=210, name='pat_first_name',
               transformation_id=38, value="Pat First Name"),
            ...
            tv(id=220, name='status_date',
               transformation_id=38, value="Status Date"),
            tv(id=221, name='status_code',
               transformation_id=38, value="Status Code"),
            tv(id=222, name='sub_status', transformation_id=38, value="Sub Status"),
            tv(id=223, name='pres_last_name',
               transformation_id=38, value="Pres Last Name"),
            tv(id=224, name='pres_first_name',
               transformation_id=38, value="Pres First Name"),
            ...
            tv(id=233, name='facility_name',
               transformation_id=38, value="Facility Name"),
            ...
            tv(id=238, name='refill_remaining',
               transformation_id=38, value="Refill Remaining"),
            tv(id=239, name='prev_disp', transformation_id=38, value="prev Disp"),
            tv(id=240, name='rx_ndc_number',
               transformation_id=38, value="Rx NDC Number"),
            ...
            tv(id=245, name='ship_carrier',
               transformation_id=38, value="Ship Carrier"),
            tv(id=246, name='shiptracking_num',
               transformation_id=38, value="shipTracking Num"),
            tv(id=247, name='ship_location',
               transformation_id=38, value="Ship Location"),
            tv(id=248, name='ship_address',
               transformation_id=38, value="Ship Address"),
            ...
            tv(id=252, name='has_medical',
               transformation_id=38, value="Has Medical"),
            tv(id=253, name='primary_coverage_type',
               transformation_id=38, value="Primary Coverage Type"),
            tv(id=254, name='primary_payer_name',
               transformation_id=38, value="Primary Payer Name"),
            tv(id=255, name='primary_payer_type',
               transformation_id=38, value="PrimaryPayer Type"),
            tv(id=256, name='secondary_coverage_type',
               transformation_id=38, value="Secondary Coverage Type"),
            tv(id=257, name='secondary_payer_name',
               transformation_id=38, value="Secondary Payer Name"),
            tv(id=258, name='secondary_payer_type',
               transformation_id=38, value="Secondary Payer Type"),
            tv(id=259, name='plan_paid_amt',
               transformation_id=38, value="Plan Paid Amt"),
            tv(id=260, name='pat_copay', transformation_id=38, value="Pat Copay"),
            tv(id=261, name='copay_assist_amount',
               transformation_id=38, value="Copay Assist Amount"),
            tv(id=262, name='oth_payer_amt',
               transformation_id=38, value="Oth Payer Amt"),
            tv(id=263, name='xfer_pharmname',
               transformation_id=38, value="Xfer PharmNameCA"),
            tv(id=264, name='msa_patient_id',
               transformation_id=38, value="MSA PATIENT ID"),
            tv(id=265, name='msa_patient_bmap',
               transformation_id=38, value="MSA PATIENT BMAP"),
            tv(id=410, name='metadata_run_timestamp',
               transformation_id=38, value="__metadata_run_timestamp"),
            tv(id=411, name='metadata_app_version',
               transformation_id=38, value="__metadata_app_version"),
            tv(id=412, name='metadata_output_contract',
               transformation_id=38, value="__metadata_output_contract"),

            tv(id=266, name='ingest_source_transform',
               transformation_id=39, value="initial_ingest"),
            tv(id=267, name='ingest_source_file_prefix', transformation_id=39,
               value="INTEGRICHAIN_SUN_CVS_STATUSDISPENSE"),
            tv(id=268, name='rec_date_col', transformation_id=39, value="Rec Date"),
            tv(id=269, name='pharm_code_col',
               transformation_id=39, value="Pharm Code"),
            ...
            tv(id=272, name='pharm_transaction_id',
               transformation_id=39, value="Pharm Transaction ID"),
            ...
            tv(id=277, name='pharmacy_id',
               transformation_id=39, value="Pharmacy ID"),
            tv(id=278, name='pat_last_name',
               transformation_id=39, value="Pat Last Name"),
            tv(id=279, name='pat_first_name',
               transformation_id=39, value="Pat First Name"),
            ...
            tv(id=289, name='status_date',
               transformation_id=39, value="Status Date"),
            tv(id=290, name='status_code',
               transformation_id=39, value="Status Code"),
            tv(id=291, name='sub_status', transformation_id=39, value="Sub Status"),
            tv(id=292, name='pres_last_name',
               transformation_id=39, value="Pres Last Name"),
            tv(id=293, name='pres_first_name',
               transformation_id=39, value="Pres First Name"),
            ...
            tv(id=302, name='facility_name',
               transformation_id=39, value="Facility Name"),
            ...
            tv(id=307, name='refill_remaining',
               transformation_id=39, value="Refill Remaining"),
            tv(id=308, name='prev_disp', transformation_id=39, value="prev Disp"),
            tv(id=309, name='rx_ndc_number',
               transformation_id=39, value="Rx NDC Number"),
            ...
            tv(id=314, name='ship_carrier',
               transformation_id=39, value="Ship Carrier"),
            tv(id=315, name='shiptracking_num',
               transformation_id=39, value="shipTracking Num"),
            tv(id=316, name='ship_location',
               transformation_id=39, value="Ship Location"),
            tv(id=317, name='ship_address',
               transformation_id=39, value="Ship Address"),
            ...
            tv(id=321, name='has_medical',
               transformation_id=39, value="Has Medical"),
            tv(id=322, name='primary_coverage_type',
               transformation_id=39, value="Primary Coverage Type"),
            tv(id=323, name='primary_payer_name',
               transformation_id=39, value="Primary Payer Name"),
            tv(id=324, name='primary_payer_type',
               transformation_id=39, value="Primary Payer Type"),
            tv(id=325, name='secondary_coverage_type',
               transformation_id=39, value="Secondary Coverage Type"),
            tv(id=326, name='secondary_payer_name',
               transformation_id=39, value="Secondary PayerName"),
            tv(id=327, name='secondary_payer_type',
               transformation_id=39, value="Secondary PayerType"),
            tv(id=328, name='plan_paid_amt',
               transformation_id=39, value="Plan Paid Amt"),
            tv(id=329, name='pat_copay', transformation_id=39, value="Pat Copay"),
            tv(id=330, name='copay_assist_amount',
               transformation_id=39, value="Copay Assist Amount"),
            tv(id=331, name='oth_payer_amt',
               transformation_id=39, value="Oth Payer Amt"),
            tv(id=332, name='xfer_pharmname',
               transformation_id=39, value="Xfer Pharm Name"),
            tv(id=333, name='msa_patient_id',
               transformation_id=39, value="MSA PATIENT ID"),
            tv(id=334, name='msa_patient_bmap',
               transformation_id=39, value="MSA PATIENT BMAP"),
            tv(id=413, name='metadata_run_timestamp',
               transformation_id=39, value="__metadata_run_timestamp"),
            tv(id=414, name='metadata_app_version',
               transformation_id=39, value="__metadata_app_version"),
            tv(id=415, name='metadata_output_contract',
               transformation_id=39, value="__metadata_output_contract"),

            tv(id=335, name='ingest_source_transform',
               transformation_id=40, value="initial_ingest"),
            tv(id=336, name='ingest_source_file_prefix', transformation_id=40,
               value="INTEGRICHAIN_SUN_WALGREENS_STATUSDISPENSE"),
            tv(id=337, name='rec_date_col', transformation_id=40, value="Rec Date"),
            tv(id=338, name='pharm_code_col',
               transformation_id=40, value="Pharm Code"),
            ...
            tv(id=341, name='pharm_transaction_id',
               transformation_id=40, value="Pharm Transaction Id"),
            ...
            tv(id=346, name='pharmacy_id',
               transformation_id=40, value="Pharmacy ID"),
            tv(id=347, name='pat_last_name',
               transformation_id=40, value="Pat Last Name"),
            tv(id=348, name='pat_first_name',
               transformation_id=40, value="Pat First Name"),
            ...
            tv(id=358, name='status_date',
               transformation_id=40, value="Status Date"),
            tv(id=359, name='status_code',
               transformation_id=40, value="Status Code"),
            tv(id=360, name='sub_status', transformation_id=40, value="Sub Status"),
            tv(id=361, name='pres_last_name',
               transformation_id=40, value="Pres Last Name"),
            tv(id=362, name='pres_first_name',
               transformation_id=40, value="Pres First Name"),
            ...
            tv(id=371, name='facility_name',
               transformation_id=40, value="Facility Name"),
            ...
            tv(id=376, name='refill_remaining',
               transformation_id=40, value="Refill Remaining"),
            tv(id=377, name='prev_disp', transformation_id=40, value="prev Disp"),
            tv(id=378, name='rx_ndc_number',
               transformation_id=40, value="Rx NDC Number"),
            ...
            tv(id=383, name='ship_carrier',
               transformation_id=40, value="Ship Carrier"),
            tv(id=384, name='shiptracking_num',
               transformation_id=40, value="shipTracking Num"),
            tv(id=385, name='ship_location',
               transformation_id=40, value="Ship Location"),
            tv(id=386, name='ship_address',
               transformation_id=40, value="Ship Address"),
            ...
            tv(id=390, name='has_medical',
               transformation_id=40, value="Has Medical"),
            tv(id=391, name='primary_coverage_type',
               transformation_id=40, value="Primary CoverageType"),
            tv(id=392, name='primary_payer_name',
               transformation_id=40, value="Primary Payer Name"),
            tv(id=393, name='primary_payer_type',
               transformation_id=40, value="Primary Payer Type"),
            tv(id=394, name='secondary_coverage_type',
               transformation_id=40, value="Secondary CoverageType"),
            tv(id=395, name='secondary_payer_name',
               transformation_id=40, value="Secondary PayerName"),
            tv(id=396, name='secondary_payer_type',
               transformation_id=40, value="Secondary PayerType"),
            tv(id=397, name='plan_paid_amt',
               transformation_id=40, value="Plan Paid Amt"),
            tv(id=398, name='pat_copay', transformation_id=40, value="Pat Copay"),
            tv(id=399, name='copay_assist_amount',
               transformation_id=40, value="Copay Assist Amount"),
            tv(id=400, name='oth_payer_amt',
               transformation_id=40, value="Oth Payer Amt"),
            tv(id=401, name='xfer_pharmname',
               transformation_id=40, value="Xfer PharmName"),
            tv(id=402, name='msa_patient_id',
               transformation_id=40, value="MSA PATIENT ID"),
            tv(id=403, name='msa_patient_bmap',
               transformation_id=40, value="MSA PATIENT BMAP"),
            tv(id=416, name='metadata_run_timestamp',
               transformation_id=40, value="__metadata_run_timestamp"),
            tv(id=417, name='metadata_app_version',
               transformation_id=40, value="__metadata_app_version"),
            tv(id=418, name='metadata_output_contract',
               transformation_id=40, value="__metadata_output_contract"),
